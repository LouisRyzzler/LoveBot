                ...
                this.message.channel.send(
                    new MessageEmbed()
                        ...
                        .addFields(
                            ...
                            {name:"Avantages", value:"```▫️ Vous obtenez tous les avantages du rôle <@&876526738174255134>.\n▫️ Vous aurez un rôle affiché séparément des autres \n▫️ Vous pouvez participer aux giveaways sans respecter aucunes conditions.\n▫️ Vous gagnez l'accès au channel <#834555074045804605>.```", inline: false}
                        )
