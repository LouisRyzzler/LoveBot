                ...
                this.message.author.send(
                    new MessageEmbed()
                        ...
                        .addFields(
                            ...
                            { name: "Rôles", value: "<:pointer:863335546751287306> ``!gold`` ce rôle s'obtient en invitant ``3`` personnes sur le serveur. Taper cette commande vous montreras tous les avantages de ce rôle."},
