                ...
                this.message.channel.send(
                    new MessageEmbed()
                        ...
                        .addFields(
                            ...
                            { name: "Rôles", value: "<:pointer:863335546751287306> <@&868813991630237706> ce rôle s'obtient en invitant ``3`` personnes sur le serveur. Taper la commande``!dice`` vous montreras tous les avantages de ce rôle."},
